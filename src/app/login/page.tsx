...
/**
 * G7 Hotels Login Page
 * User authentication with modern design
 */
          ...
          >
            <Card className="p-8 border-g7-gold/30">
              <div className="text-center mb-8">
                <h2 className="font-serif text-3xl text-g7-charcoal mb-2">Sign In</h2>
                <p className="text-g7-charcoal/70">
                  Welcome back to G7 Hotels. Please sign in to access your account.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-sm text-g7-gold hover:underline"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-sm text-g7-charcoal/70">
              ...
              <div className="mt-6">
                <div className="relative">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-g7-gold/20" />
                  </div>
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-g7-charcoal/60">Or continue with</span>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <Button
                    variant="outline"
                    type="button"
                    className="border-g7-gold/50 text-g7-charcoal hover:bg-g7-gold/10"
                  >
              ...
              <p className="mt-8 text-center text-sm text-g7-charcoal/70">
                ...
                <Link href="/register" className="text-g7-gold font-semibold hover:underline">
                  Create one
                </Link>
              </p>
            </Card>
            ...
            <Card className="mt-6 p-6 bg-g7-gold/5 border-g7-gold/20">
              <h3 className="font-semibold text-g7-charcoal mb-4">Member Benefits</h3>
